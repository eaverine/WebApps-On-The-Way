...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_recent_question(self):
        ...
        whose pub_date is is within the last day
        """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        """
        Questions with a pub_date in the past should be retrieved in the Index page
        """
    ...
    def test_future_question(self):
        """
        Questions with a pub_date shouldn't be displayed on the Index page
        """
...
class QuestionDetailViewTests(TestCase):
    def test_past_question(self):
        ...
        """
        past_question = create_question(question_text = 'Past quetion', days = -5)
